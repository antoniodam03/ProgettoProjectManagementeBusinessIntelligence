...
\begin{enumerate}
    ...
    Alcuni record del \textit{Global Terrorism Dataset} contenevano informazioni temporali organizzate in colonne separate (\texttt{year}, \texttt{month}, \texttt{day}).
    Si è proceduto alla creazione di una colonna unificata \texttt{date}, ottenuta combinando anno, mese e giorno in un unico campo di tipo data.   
